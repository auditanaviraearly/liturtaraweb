...
<head>
    ...
    <title>Account - Case Owner</title>
        ...
        <main class="flex-1 p-10">
            ...
            <div class="bg-white shadow-md rounded-lg p-6 mt-4">
                ...
                <div class="w-24 h-24 bg-gray-300 rounded-lg overflow-hidden">
                    ...
                    <button class="border border-red-500 text-red-500 px-4 py-2 rounded-md hover:bg-red-500 hover:text-white">Delete</button>
                </div>
                
                <div class="mt-6 space-y-4">
                    <div class="flex flex-col">
                        <label class="text-gray-700">Full Name</label>
                        <input type="text" class="border px-4 py-2 rounded w-2/3" value="John Doe">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-gray-700">Date of Birth</label>
                        <input type="date" class="border px-4 py-2 rounded w-2/3" value="1999-10-10">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-gray-700">Domicile</label>
                        <input type="text" class="border px-4 py-2 rounded w-2/3" value="Kota Bandung">
                    </div>

            <!-- Gender (Sekarang dalam bentuk kolom) -->
                    <div class="flex flex-col">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" class="border px-4 py-2 rounded w-2/3" value="081234567890">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-gray-700">Email</label>
                        <input type="text" class="border px-4 py-2 rounded w-2/3" value="liturtara@gmail.com">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-gray-700">Password</label>
                        <input type="text" class="border px-4 py-2 rounded w-2/3">
                    </div>
